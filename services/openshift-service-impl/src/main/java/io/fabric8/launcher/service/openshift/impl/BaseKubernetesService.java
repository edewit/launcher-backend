...
abstract class BaseKubernetesService implements OpenShiftService, OpenShiftServiceSpi {
...
//    }
    ...
    BaseKubernetesService(final OpenShiftServiceFactory.Parameters parameters) {
    ...
    @Override
    public boolean deleteProject(OpenShiftProject project) throws IllegalArgumentException {
        if (project == null) {
    ...
    List<Parameter> getParameters(OpenShiftProject project, String sourceRepositoryProvider,
