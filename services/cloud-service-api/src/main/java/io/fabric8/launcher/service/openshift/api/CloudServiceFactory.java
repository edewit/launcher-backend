...
/**
 * Creates {@link CloudService} instances
 *
...
public interface CloudServiceFactory {
    ...
    /**
     * Returns an {@link CloudService} using the default authentication in the default cluster
     *
     * @return an {@link CloudService}
     */
    CloudService create();

    /**
     * Returns an {@link CloudService} given its {@link Parameters}
     *
     * @param parameters an identity
     * @return an {@link CloudService}
     */
    CloudService create(Parameters parameters);
