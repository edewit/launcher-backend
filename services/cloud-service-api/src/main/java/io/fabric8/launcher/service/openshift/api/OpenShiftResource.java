 ...
 * OpenShift resources belong to an {@link CloudProject}, have a name and a kind
 */
@Value.Immutable
public interface OpenShiftResource {
    ...
    /**
     * @return the parent {@link CloudProject} of this OpenShift resource
     */
    CloudProject getProject();
