...
public class DeleteOpenShiftProjectRule extends ExternalResource {
     ...
     */
    private final Collection<CloudProject> createdProjects = new ArrayList<>();
     ...
     */
    public void add(final CloudProject project) {
    ...
    protected void after() {
        createdProjects.forEach(project -> {
            ...
            final boolean deleted = ((CloudServiceSpi) test.getCloudService()).deleteProject(project);
