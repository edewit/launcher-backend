...
/**
 * Produces {@link CloudService} instances per-request
 *
 * @author <a href="mailto:ggastald@redhat.com">George Gastaldi</a>
 */
@ApplicationScoped
public class CouldServiceProducer {
     ...
     */
    @Deprecated
    CouldServiceProducer() {
        this.factory = null;
        this.clusterRegistry = null;
    }

    @Inject
    CouldServiceProducer(CloudServiceFactory factory, OpenShiftClusterRegistry clusterRegistry) {
    ...
    @RequestScoped
    @Produces
    CloudService getOpenShiftService(final HttpServletRequest request,
